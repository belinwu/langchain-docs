...
Skills are reusable capabilities that provide specialized workflows and domain knowledge to your agent. Each skill is stored in the agent's long-term memory at `memories/skills/<skill-name>` and is only loaded when the agent determines it's relevant to the current task.
...
- **With AI**: Use natural language to describe the skill and the agent will create it for you.
- **Manually**: Create a skill with a `SKILL.md` file and any additional resources you need.
