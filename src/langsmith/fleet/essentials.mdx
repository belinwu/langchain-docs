...
Tools work regardless of how the agent was triggered. For example, with a [custom Slack bot](/langsmith/fleet/slack-app), you can start a task in the Fleet chat UI and have the agent send you a Slack message when it's done.
