...
Slack tools let your agent send messages, reply in threads, and read channel history. They work regardless of how the agent was triggered — through Slack, the Fleet UI, a schedule, or a webhook.
