...
Slack tools require a custom Slack bot. They let your agent send messages, reply in threads, and read channel history. Slack tools work regardless of how the agent was triggered — through Slack, the Fleet UI, a schedule, or a webhook.
