---
title: Overview
description: Build UIs that display real-time subagent streams, task progress, and sandbox IDEs for Deep Agents
---
...
<CardGroup cols={3}>
  ...
  <Card title="Sandbox IDE" icon="code" href="/oss/javascript/deepagents/frontend/sandbox">
